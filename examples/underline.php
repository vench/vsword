...
* In the document added header and added two paragraphs with underline. 
*/
...
$rParagraph3->addTextStyle(new UnderlineStyleNode());
$rParagraph3->addText('Italic text and underline');

$body->addNode( $paragraph2 );
 

$doc->saveAs('./base-ul.docx');
